...
DOCUMENTATION = """
lookup: latest_java_agent_version
author: Continuous Cloud
version_added: "1.0.0"
short_description: Lookup the latest available version of a NR java APM agent
description:
    - Lookup the latest available version of a NR java APM agent
options: {}
"""

USAGE = """
    - name: Lookup The Latest Java Version
      debug:
        msg: "{{ lookup('newrelic.apm.latest_java_agent_version') }}"
"""
...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables=None, **kwargs):
        version_feed_url = (
            ...
            "agent-release-notes/java-release-notes/feed.xml"
        )
